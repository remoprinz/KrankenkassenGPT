...
- ✅ Supabase Account mit Projekt
- ✅ ChatGPT Plus Account (für Custom GPT)
...
```sql
-- Insurers Tabelle (optional, für Namen)
...
**Dauer:** ~20-25 Minuten für alle Jahre
...
## 4️⃣ FIREBASE FUNCTIONS DEPLOYEN
...
4. Description: "Offizieller Prämienberater mit BAG-Daten"

### 5.2 Instructions kopieren

1. Öffnen Sie `GPT_INSTRUCTIONS_FINAL_COMPACT.md`
2. Kopieren Sie den gesamten Inhalt
3. Fügen Sie ihn im GPT Builder unter **Instructions** ein

### 5.3 Actions konfigurieren

**Import OpenAPI Schema:**
1. **Actions** → **Create new action**
2. **Import from file** → Wählen Sie `openapi-chatgpt-historical.yaml`
...
1. "Was kostet CSS für einen Mann, 52, in 8000 Zürich, HMO, ohne Unfallversicherung?"
2. "Zeige mir die günstigsten 5 Krankenkassen für Zürich"
3. "Wie hat sich CSS entwickelt die letzten 10 Jahre?"
4. "Vergleiche CSS mit Assura"

**Erwartetes Ergebnis:**
- PLZ-Abfrage funktioniert
- Prämien werden korrekt angezeigt
...
Falls Änderungen an den Instructions nötig sind:
1. Bearbeiten Sie `GPT_INSTRUCTIONS_FINAL_COMPACT.md`
2. Kopieren Sie den neuen Text
3. Fügen Sie ihn im GPT Builder ein
4. Speichern
...
console.log('Total Prämien:', count);
"
```
...
**Ursache:** Große Zeiträume (2016-2026) können langsam sein  
**Lösung:** Verkürzen Sie den Zeitraum oder optimieren Sie Indizes

### Problem: "Duplicate key violation"
**Ursache:** Daten wurden schon importiert  
**Lösung:** Löschen Sie das Jahr zuerst oder verwenden Sie ein neues Jahr

### Problem: "No results found"
**Ursache:** Nicht alle Kombinationen existieren  
**Lösung:** Versuchen Sie andere Franchisen oder Modelle
...
**Viel Erfolg mit Ihrem Schweizer Krankenkassen-Experten! 🇨🇭**
